# Curlew Agent Event Stream — v1.0
...
v1.0 is the **first stable release** of the Curlew agent event stream. It is
...
```json
{"schema_version":"1.0","run_id":"a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4","id":1,"at_ms":0,"kind":"run.start","started_at":"2026-04-21T10:00:00Z","curlew_version":"1.0.0","cli_args":["run","tests.yaml"]}
```

Maximal example (all fields):

```json
{"schema_version":"1.0","run_id":"a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4","id":1,"at_ms":0,"kind":"run.start","started_at":"2026-04-21T10:00:00Z","curlew_version":"1.0.0","cli_args":["run","tests.yaml","--env","staging"],"collection_file":"tests.yaml","env_name":"staging"}
```
