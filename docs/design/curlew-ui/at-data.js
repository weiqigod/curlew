/* curlew UI — mock data: a payments API repo (paymux-api) */
window.AT = (function () {
  const ENVS = [
  ...
  const chargeBody = {
    ...
    metadata: { order_id: 'ord_18472', source: 'curlew' },
    livemode: false,
    created: 1718102400,
  };
  ...
  const INSPECT = {
    'chg-create': {
      ...
      reqBody: { amount: 4200, currency: 'usd', customer: 'cus_QfT81LbNa2', capture: false, metadata: { order_id: 'ord_18472', source: 'curlew' } },
      yaml: [
