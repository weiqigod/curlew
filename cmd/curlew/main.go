...
func printHelpTo(w io.Writer) {
	...
	_, _ = fmt.Fprintln(w, "  --events <file>     Write an NDJSON event stream for the run (schema v1.5)")
	_, _ = fmt.Fprintln(w, "                      One JSON object per line; see docs/EVENTS_SCHEMA_v1.5.md")
