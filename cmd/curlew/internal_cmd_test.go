...
func TestSeedLogin_WritesIsolatedFileState(t *testing.T) {
	...
	t.Setenv("CURLEW_INTERNAL_DEVICE_ID", "dev-e2e")
	t.Setenv("CURLEW_INTERNAL_REFRESH_TOKEN", "rt-e2e")
	t.Setenv("CURLEW_INTERNAL_ACCESS_TOKEN", "at-e2e")
...
func TestBackendProbe_BinaryEndToEnd(t *testing.T) {
	...
	env := append(os.Environ(), "CURLEW_INTERNAL=1")
