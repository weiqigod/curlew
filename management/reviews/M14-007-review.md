...
| Naming | PASS | No stuttering; all exported symbols have doc comments; `VerifyRS256` fully removed with no alias; no `apitest-2025-0x` kid strings remain in production code |
...
- `cmd/apitest/...`: 81.5% — above 80% DoD threshold
