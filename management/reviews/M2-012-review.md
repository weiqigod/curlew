...
| Code Organization | PASS | Clean boundary between `internal/watch/` and `cmd/apitest/`. `runCmdInner` extraction is minimal-surface refactor. Exported API is narrow. |
