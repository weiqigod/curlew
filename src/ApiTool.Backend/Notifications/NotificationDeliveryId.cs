...
/// <summary>Wire-format id helper (<c>ndel_&lt;32-hex-chars&gt;</c>).</summary>
public static class NotificationDeliveryId
{
    private const string Prefix = "ndel_";

    /// <summary>Formats a <see cref="Guid"/> as a <c>ndel_</c>-prefixed hex string.</summary>
    public static string Format(Guid id) => Prefix + id.ToString("N");

    /// <summary>
    /// Attempts to parse a <c>ndel_</c>-prefixed wire-format id back to a <see cref="Guid"/>.
    /// </summary>
