// Wire format for the per-row AES-256-GCM envelope used by IGitLabKeyProvider implementations.
...
/// <summary>
/// Codec for the AES-256-GCM envelope that stores the GitLab PAT ciphertext.
/// Wire format of the final blob produced by <see cref="Pack"/>:
/// <c>[0x01][be u16: wrappedDekLen][wrappedDek][12-byte nonce][N bytes ciphertext][16-byte tag]</c>.
