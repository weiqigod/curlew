// Configuration options for team vault template encryption (M18-009).
namespace ApiTool.Backend.VaultConfig.Keys;

/// <summary>
/// Top-level configuration for team vault envelope encryption.
/// Bound from <c>ApiTool:TeamVault:Encryption</c>
/// (env vars use <c>TEAMVAULT__</c> prefix alias — see Program.cs).
/// </summary>
public sealed class TeamVaultEncryptionOptions
{
    /// <summary>Configuration section name.</summary>
    public const string Section = "ApiTool:TeamVault:Encryption";
